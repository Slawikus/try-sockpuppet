...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/enums.js
const inputTags = {
  INPUT: true,
  TEXTAREA: true,
  SELECT: true
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/utils.js
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/callbacks.js
...
;// CONCATENATED MODULE: ./node_modules/cable_ready/javascript/cable_ready.js
...
/* harmony default export */ const cable_ready = ({
  perform,
  performAsync,
  DOMOperations,
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/schema.js
const schema_defaultSchema = {
...
var action_cable = __webpack_require__(877);
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/consumer.js
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/utils.js
...
const utils_camelize = (value, uppercaseFirstLetter = true) => {
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/debug.js
let debugging = false

/* harmony default export */ const javascript_debug = ({
  get enabled () {
    return debugging
  },
  get disabled () {
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/lifecycle.js
...
const invokeLifecycleMethod = (
  ...
  const specificLifecycleMethodName = ['before', 'after', 'finalize'].includes(
    ...
    ? `${stage}${utils_camelize(reflexMethodName)}`
    : `${utils_camelize(reflexMethodName, false)}${utils_camelize(stage)}`
...
const dispatchLifecycleEvent = (
  ...
  if (!controllerElement) {
    if (javascript_debug.enabled && !reflexes[reflexId].warned) {
      console.warn(
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/attributes.js
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/controllers.js
...
;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/log.js
function request (
  reflexId,
  target,
  args,
...
/* harmony default export */ const log = ({ request, success, error: log_error });

;// CONCATENATED MODULE: ./node_modules/stimulus_reflex/javascript/stimulus_reflex.js
  ...
  controller.StimulusReflex.subscription =
    ...
    actionCableConsumer.subscriptions.create(subscription, {
      received: data => {
        ...
        if (reflexData) {
          ...
          if (reflexes[reflexId]) {
            ...
            cable_ready.perform(reflexOperations)
          }
        }

        // run piggy back operations after stimulus reflex behavior
        cable_ready.perform(data.operations)
      },
      connected: () => {
      ...
      rejected: () => {
        ...
        if (javascript_debug.enabled) console.warn('Channel subscription was rejected.')
      },
  ...
  Object.assign(controller, {
    ...
    stimulate () {
      ...
      if (
        ...
        if (javascript_debug.enabled) console.warn('Reflex aborted: invalid numeric input')
        return
      }
      const options = {}
      if (
...
const registerReflex = data => {
  ...
  if (javascript_debug.enabled) promise.catch(NOOP)
...
const initialize = (application, initializeOptions = {}) => {
  ...
  stimulusApplication.schema = { ...schema_defaultSchema, ...application.schema }
  stimulusApplication.register(
    'stimulus-reflex',
    controller || StimulusReflexController
  )
  javascript_debug.set(!!debug)
}
...
if (!document.stimulusReflexInitialized) {
  ...
  const afterDOMUpdate = event => {
    ...
    if (javascript_debug.enabled) log.success(event)
  ...
  document.addEventListener('stimulus-reflex:server-message', event => {
    ...
    if (javascript_debug.enabled) log[subject === 'error' ? 'error' : 'success'](event)
...
/* harmony default export */ const stimulus_reflex = ({
  ...
  register,
  get debug () {
    return javascript_debug.value
  },
  set debug (value) {
    javascript_debug.set(!!value)
  }
});
...
function reconnecting_websocket_mjs_extends(d, b) {
    extendStatics(d, b);
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
}
...
var ErrorEvent = /** @class */ (function (_super) {
    reconnecting_websocket_mjs_extends(ErrorEvent, _super);
...
var CloseEvent = /** @class */ (function (_super) {
    reconnecting_websocket_mjs_extends(CloseEvent, _super);
...
const stimulus_websocket_extend = function(object, properties) {
    if (properties != null) {
...
class Subscription {
    constructor(consumer, params = {}, mixin) {
        this.consumer = consumer
        this.identifier = JSON.stringify(params)
        stimulus_websocket_extend(this, mixin)
    }
...
;// CONCATENATED MODULE: ./javascript/src/javascript/controllers/counter_controller.js



/* harmony default export */ const counter_controller = (class extends Controller {
  connect() {
